...
Public Class UserControlDateBox
    ...
    Sub New()
        ...
        Name = "Empty"
        DateTimePicker.Value = CDate(Date.Now.ToShortDateString)
        EnumOfType = UserControl.EnumTypeOfControls.DateBox
        TypeOfControls = GetType(UserControlDateBox)
    End Sub
...
#End Region
    ...
    Public Overloads Sub EraseValue() Implements IUserControl.EraseValue
        DateTimePicker.Value = CDate(Date.Now.ToShortDateString)
        mUserValue = DateTimePicker.Value.ToShortDateString
    End Sub
...
#Region "Control Properties"
    ...
    Public Property Value() As String Implements IUserControl.Value
        ...
        Set(ByVal value As String)
            mUserValue = value
            DateTimePicker.Value = CType(mUserValue, Date)
        End Set
    End Property
